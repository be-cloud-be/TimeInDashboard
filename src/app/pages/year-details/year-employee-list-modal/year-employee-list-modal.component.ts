...
@Component({
  selector: 'year-employee-list-modal',
  templateUrl: './year-employee-list-modal.component.html',
  styleUrls: ['./year-employee-list-modal.component.scss']
})
export class YearEmployeeListModalComponent implements OnInit {
